...
public class ConfigManager {
    ...
    public boolean isOneHeartModeEnabled() {
        return plugin.getConfig().getBoolean("features.one_heart.enabled", false);
    }
    
    public void setOneHeartModeEnabled(boolean enabled) {
        plugin.getConfig().set("features.one_heart.enabled", enabled);
        plugin.saveConfig();
    }
